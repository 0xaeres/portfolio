...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    desc: 'An agentic offensive-security platform where LLM-backed strategist agents analyze findings, generate and rank vulnerability hypotheses, orchestrate security tools, and drive an analyze → hypothesize → simulate → judge → report loop. Deterministic policy gates keep every action scoped and human-governed.',
    stack: ['AGENTIC AI', 'LLM STRATEGIST', 'PYTHON', 'SLITHER', 'FOUNDRY'],
