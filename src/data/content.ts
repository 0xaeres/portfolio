...
export const PROJECTS: Project[] = [
  ...
  },
  {
    num: '02',
    name: 'Nazgul',
    kind: 'SECURITY ORCHESTRATION',
    tag: 'ADVERSARY EMULATION',
    period: 'JUL 2026 — PRESENT',
    desc: 'A human-governed platform for authorized security assessment and adversary emulation. It turns bounded security objectives into evidence-backed operations through deterministic policy checks, isolated tool execution, impact budgets, and independent evidence judging.',
    stack: ['PYTHON', 'PYDANTIC', 'SLITHER', 'FOUNDRY', 'MYTHRIL'],
    href: 'https://github.com/0xaeres/nazgul',
    flip: true,
  },
  {
    num: '03',
